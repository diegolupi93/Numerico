...
function lab2ej7newton(fun,x0,err,iter)
    ...
    for i in 0.0:0.1:1.5 # i itera de 0 a 1.5 en intervalos de 0.1
        ...
        eval = fun(last_x)  # evaluo la fun en el ultimo x que obtengo en metodo de newton, esto quiere decir el mas cercano a la raiz
...
res = ripf(fun_lab2ej6,0.7,10^-5,100)
using Plots
